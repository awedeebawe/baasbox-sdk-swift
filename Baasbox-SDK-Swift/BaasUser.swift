 ...
 */
open class BaasUser: NSObject, NSCoding {
    ...
    */
    open func update(_ completion: BaasBox.BaasCompletion) {
        BaasBox.shared.put("/me", parameters: ["visibleByTheUser" : visibleByTheUser, "visibleByFriends" : visibleByFriends, "visibleByAnonymousUsers": visibleByAnonymousUsers, "visibleByRegisteredUsers" : visibleByRegisteredUsers], completion: { ( success, data, error ) in
            if success {
     ...
     */
    open func logout(_ pushToken: String = "",completion: BaasBox.BaasCompletion ) {
        let url = pushToken == "" ? "/logout" : "/logout/"+pushToken
        BaasBox.shared.post(url, parameters: [:], completion: { ( success, data, error ) in
     ...
     */
    open func refresh(_ completion: BaasBox.BaasCompletion ) {
        BaasBox.shared.get("/me", parameters: [:], completion: { ( success, data, error ) in
            if success {
    ...
    /**
     ...
     - parameters:
        ...
        - to : New password
     */
    open func changePassword(_ from: String, to: String, completion: BaasBox.BaasCompletion) {
        BaasBox.shared.put("/me/password", parameters: ["old": from, "new" : to], completion: {( success, data, error ) in
            if success {
                BaasBox.shared.login(BaasBox.shared.user.username, password: to, completion: {(success, data, error) in
                    completion(success, data, error)
                })
            }
            completion(success, data, error )
     ...
     */
    open func link(_ to: BaasBox.socialTypes, token: String, completion: BaasBox.BaasCompletion) {
        BaasBox.shared.put("/social/"+to.rawValue, parameters: ["oauth_token": token, "oauth_secret": token], completion: { (success, data, error) in
            completion(success,data,error)
        })
    }
     ...
     */
    open func follow(_ username: String, completion: BaasBox.BaasCompletion) {
        BaasBox.shared.post("/follow/"+username, parameters: [:], completion: { (success, data, error) in
            completion(success,data,error)
        })
    }
     ...
     */
    open func unfollow(_ username: String, completion: BaasBox.BaasCompletion) {
        BaasBox.shared.delete("/follow/"+username, parameters: [:], completion: { (success, data, error) in
            completion(success,data,error)
        })
    }
     ...
     */
    open func getFollows(_ completion: BaasBox.BaasCompletion) {
        BaasBox.shared.get("/following/"+self.username, parameters: [:], completion: { (success, data, error) in
            completion(success, data, error)
        })
    }
     ...
     */
    open func getFollowers(_ completion: BaasBox.BaasCompletion) {
        BaasBox.shared.get("/followers/"+self.username, parameters: [:], completion: { (success, data, error) in
            completion(success, data, error)
        })
    }
}
